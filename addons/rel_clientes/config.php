...
<?php
		...
		//Conexï¿½oo com o Banco de Dados
		...
		// Ativar Pesquisa no Busca Inteligente?
		// Troque o false por true - para ativar
		if(!file_exists("../busca_inteligente/index.php")){
			$busca_inteligente_instalado = false;
		}else{
			$busca_inteligente_instalado = true;
		}

		// Clientes cancelados = excluï¿½dos do sistema?
		$cli_del_cancelalado = false;
		...
		//$usuario_logado =  $_SESSION['MM_Usuario']; // MK-AUTH VERSOES ANTIGAS
