...
<body>
    ...
    <div class="container-fluid">
        ...
        <?php
        $query_ler_notificacoes = mysqli_query($conn, "SELECT * FROM dashboard_am_sis_notificacoes WHERE data LIKE '$data%' AND (id_remetente LIKE '$usuario[$usuario_logado]' OR id_usuario LIKE '$usuario[$usuario_logado]') AND id_usuario LIKE '$user_select'");
