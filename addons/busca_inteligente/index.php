...
<body class="">
    ...
    <style>
        ...
        .search-stat-grid { display:flex; flex-wrap:wrap; justify-content:center; gap:9px; margin:0 15px 12px; padding:11px; border:1px solid #dbe5f0; border-radius:16px; background:#fff; box-shadow:0 8px 22px rgba(15,23,42,.04); }
        .search-stat-card { --accent:#2563a8;--soft:#edf5ff;display:grid;grid-template-columns:36px 1fr auto;align-items:center;gap:10px;flex:0 1 calc((100% - 45px)/6);min-width:180px;min-height:62px;padding:9px 11px;border:1px solid color-mix(in srgb,var(--accent) 36%,white);border-radius:12px;background:color-mix(in srgb,var(--soft) 55%,white);color:var(--accent);text-decoration:none;transition:transform .16s ease,box-shadow .16s ease,border-color .16s ease; }
        .search-stat-card:hover { color:var(--accent);transform:translateY(-2px);border-color:var(--accent);box-shadow:0 7px 16px rgba(15,23,42,.10); }
        .search-stat-icon { display:flex;align-items:center;justify-content:center;width:36px;height:36px;border-radius:50%;background:var(--soft);color:var(--accent);font-size:15px; }
        ...
        .search-stat-value { color:#172b40;font-size:20px;font-weight:750;line-height:1; }.search-stat-percent { align-self:end;padding:3px 5px;border-radius:999px;background:var(--soft);font-size:9px;font-weight:800;white-space:nowrap; }
        ...
        @supports not (color:color-mix(in srgb,red,white)){.search-stat-card{border-color:#d7e1eb;background:#fff}}
