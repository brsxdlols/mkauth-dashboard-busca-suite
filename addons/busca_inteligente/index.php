...
<body class="">
    ...
    <style>
        ...
        .smart-state-connection { display:inline-flex; align-items:center; gap:6px; margin:0; padding:5px 9px; border-radius:999px; background:rgba(255,255,255,.94)!important; color:#174a83!important; font-size:9px; font-weight:750; text-transform:uppercase; white-space:nowrap; }
