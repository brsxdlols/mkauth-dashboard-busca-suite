...
<body class="">
    ...
    <style>
        ...
        .smart-state-toast-meta { display:flex; width:100%; flex-direction:column; align-items:flex-start; flex-wrap:nowrap; gap:2px; color:#fff; font-size:10px; white-space:nowrap; overflow:hidden; }.smart-state-toast-meta span { display:block; width:100%; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
