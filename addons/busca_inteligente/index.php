...
<body class="">
    ...
    <style>
        ...
        .search-stat-content { display:flex;min-width:0;flex:1;flex-direction:column;justify-content:space-between;line-height:1.08; }.search-stat-label { order:-1;max-width:94px;margin:1px 0 8px;font-size:10px;font-weight:800;line-height:1.12;text-transform:uppercase; }
        .search-stat-number-row { display:flex;align-items:baseline;gap:4px;min-width:0;margin-top:auto;white-space:nowrap; }
        .search-stat-value { color:inherit;font-size:30px;font-weight:400;line-height:1;letter-spacing:-1px; }
        .search-stat-percent { color:inherit;font-size:9px;font-weight:800;line-height:1;letter-spacing:0;opacity:.92; }
