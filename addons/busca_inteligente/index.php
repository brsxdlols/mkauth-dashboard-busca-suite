...
<body class="">
    ...
    <style>
        ...
        .search-stat-grid { display:grid; grid-template-columns:repeat(auto-fit,minmax(185px,1fr)); gap:9px; margin:0 15px 12px; padding:11px; border:1px solid #dbe5f0; border-radius:16px; background:#fff; box-shadow:0 8px 22px rgba(15,23,42,.04); }
        .search-stat-card { --accent:#2563a8;--soft:#edf5ff;display:grid;grid-template-columns:36px 1fr auto;align-items:center;gap:10px;min-height:62px;padding:9px 11px;border:1px solid color-mix(in srgb,var(--accent) 36%,white);border-radius:12px;background:color-mix(in srgb,var(--soft) 55%,white);color:var(--accent);text-decoration:none;transition:transform .16s ease,box-shadow .16s ease,border-color .16s ease; }
        ...
        @media(max-width:700px){.search-stat-grid{grid-template-columns:repeat(2,minmax(145px,1fr));margin-inline:8px}}@media(max-width:390px){.search-stat-grid{grid-template-columns:1fr}}
