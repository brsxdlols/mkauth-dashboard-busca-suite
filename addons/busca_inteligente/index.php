...
<body class="">
    ...
    (function () {
        ...
        function applyClientReportLayout(){try{var doc=frame.contentDocument;if(!doc)return;if(clientUuid&&!doc.getElementById('mka-client-report-layout')){var style=document.createElement('link');style.id='mka-client-report-layout';style.rel='stylesheet';style.href='addons/busca_inteligente/client_pdf.css?v=3';doc.head.appendChild(style);var zoom=document.createElement('style');zoom.id='mka-client-report-screen-zoom';zoom.textContent='@media screen{html,body{font-size:12px!important;line-height:1.38!important}td,th{font-size:11.5px!important;padding:5px 8px!important}h1{font-size:26px!important}h2{font-size:19px!important}h3,h4{font-size:14px!important}}';doc.head.appendChild(zoom);}Array.prototype.forEach.call(doc.images,function(img){if(/img_nao_disp\.gif(?:\?|$)/i.test(img.src||'')){img.src='../mkfiles/logo.jpg';img.alt='Logo do provedor';img.style.objectFit='contain';}});}catch(e){}}
