...
<body class="">
    ...
    <style>
        ...
        .search-stat-grid { display:flex; flex-wrap:wrap; justify-content:center; gap:10px; width:calc(100% - 30px); max-width:1030px; margin:0 auto 14px; padding:14px; border:1px solid #d7e1eb; border-radius:16px; background:#f7f9fc; box-shadow:0 7px 20px rgba(15,23,42,.05); }
        .search-stat-card { --accent:#2563a8;--card-bg:#2563a8;position:relative;display:flex;flex:0 0 150px;height:138px;flex-direction:column;align-items:stretch;overflow:hidden;padding:12px 13px;border:1px solid var(--accent);border-radius:14px;background:var(--card-bg);color:#fff;text-decoration:none;box-shadow:0 5px 12px rgba(15,23,42,.10);transition:transform .16s ease,box-shadow .16s ease,filter .16s ease; }
        .search-stat-card:hover { color:#fff;transform:translateY(-3px);filter:brightness(1.04);box-shadow:0 10px 22px rgba(15,23,42,.18); }
        .search-stat-icon { position:absolute;top:11px;right:11px;display:flex;align-items:center;justify-content:center;width:32px;height:32px;border-radius:9px;background:rgba(255,255,255,.19);color:inherit;font-size:15px; }
        .search-stat-content { display:flex;min-width:0;flex-direction:column;line-height:1.08; }.search-stat-label { order:-1;max-width:105px;margin:1px 0 17px;font-size:11px;font-weight:800;line-height:1.15;text-transform:uppercase; }
        .search-stat-value { color:inherit;font-size:35px;font-weight:400;line-height:1;letter-spacing:-1px; }.search-stat-percent { margin-top:auto;padding-top:9px;border-top:1px solid rgba(255,255,255,.23);font-size:12px;font-weight:800;text-align:center;white-space:nowrap; }
        ...
        .search-stat-card.is-light:hover{color:#15263a}.search-stat-card.is-observation:hover,.search-stat-card.is-warning:hover{color:inherit}.search-stat-card.is-outline-danger:hover{color:#e42643}.search-stat-card.is-light .search-stat-icon{background:#edf2f7}.search-stat-card.is-outline-danger .search-stat-icon{background:#fff0f2}.search-stat-card.is-light .search-stat-percent,.search-stat-card.is-outline-danger .search-stat-percent{border-top-color:currentColor}
        @media(max-width:1060px){.search-stat-grid{max-width:710px}.search-stat-card{flex-basis:150px}}@media(max-width:740px){.search-stat-grid{max-width:530px}}@media(max-width:560px){.search-stat-grid{width:calc(100% - 16px);padding:10px}.search-stat-card{flex-basis:calc(50% - 5px);min-width:135px}}@media(max-width:350px){.search-stat-card{flex-basis:100%}}
