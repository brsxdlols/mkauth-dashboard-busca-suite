...
<body class="">
    ...
    (function () {
        ...
        function applyClientReportLayout(){try{var doc=frame.contentDocument;if(!doc)return;if(clientUuid&&!doc.getElementById('mka-client-report-layout')){var style=document.createElement('link');style.id='mka-client-report-layout';style.rel='stylesheet';style.href='addons/busca_inteligente/client_pdf.css?v=4';doc.head.appendChild(style);var zoom=document.createElement('style');zoom.id='mka-client-report-screen-zoom';zoom.textContent='@media screen{html,body{font-size:15.6px!important;line-height:1.4!important}td,th{font-size:15px!important;padding:7px 10px!important}h1{font-size:34px!important}h2{font-size:25px!important}h3,h4{font-size:18px!important}}';doc.head.appendChild(zoom);}Array.prototype.forEach.call(doc.images,function(img){if(/img_nao_disp\.gif(?:\?|$)/i.test(img.src||'')){img.src='../mkfiles/logo.jpg';img.alt='Logo do provedor';img.style.objectFit='contain';}});}catch(e){}}
