...
<?php if ($bloqueado == "sim") { ?>
                                                            ...
                                                            <?php } ?>
                                                            <a class="client-action-btn" href='#' onclick="return mkaOpenContentModal('client_report.php?uuid=<?= urlencode($uuid_cliente); ?>', <?= htmlspecialchars(json_encode('Detalhes do cliente — ' . $nome_cliente), ENT_QUOTES, 'UTF-8'); ?>);" title='DETALHES CLIENTE: <?= $nome_cliente; ?>'>
