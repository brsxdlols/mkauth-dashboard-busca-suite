...
<body class="">
    ...
    <!-- <li class="nav-item">
            <a href="#" class="nav-link">
                <img src="img/icon_ajuda.png" class="icon mostrar_dicas" />
                <div class="dicas">
                    <span class="span_mais">Sistema de Busca Inteligente</span></br>
                    <p>
                        <b>Pesquisa Simples</b></br>
                        Nome, Login, Endereço, Cidade, Plano, Telefone ou CPF..</br>
                        <b>EX:</b> Maria Silva ou Rua Nova
                    </p>

                    <p>
                        <b>Pesquisa Avançada</b></br>
                        Nome + Endereço</br>
                        Nome + Cidade</br>
                        Nome + Plano</br>
                        <b>EX:</b> Maria + Maceio
                    ...
                    <p>
                        <b>Pesquisa Especifica</b></br>
                        bloqueado, observacao ou obs, desativado, online ou on, offline ou off</br>
                        sem titulo, sem carne, adicional</br>
                        <b>EX:</b> Se buscar por <b>BLOQUEADO</b>, irá exibir todos clientes bloqueados.</br>
                    </p>

                    <p>
                        Venc + Dia de Vencimento</br>
                        <b>EX:</b> venc + 10 - Lista todos clientes com vencimento dia 10
                    </p>

                    <p>
                        <b>Pesquisa Avançada + Específica</b></br>
                        Nome + Endereço + Bloqueado ou Desativado</br>
                        Nome + Cidade + Bloqueado ou Desativado</br>
                        Nome + Plano + Bloqueado ou Desativado</br>
                        <b>EX:</b> Maria + Maceio + Bloqueado
                    </p>

                    <p>
                        <b>OBS IMPORTANTE:</b></br>
                        O Caractere <span class="span_mais">+</span> é utilizado nas consultas Avançadas, por isso deve ser informado.
                    </p>
