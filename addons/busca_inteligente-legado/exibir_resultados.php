...
<form method='POST' action='' target='_blank'>
    ...
    while ($row = mysqli_fetch_assoc($result_limit)) {
        ...
        $dataRenovacao = date('Y-m-d', strtotime('+100 year', strtotime($dataContrato)));
		...
		$porta_olt = $row['porta_olt'];
		$armario_olt = $row['armario_olt'];
        $onu_ont = $row['onu_ont'];
        ...
        $bgColor = $cont % 2 == 0 ? "bg-success-subtle" : "bg-light";
        //echo $bgColor;
        ...
        <div class='row row-cols-1 row-cols-sm-2 row-cols-md-4 small <?= $bgColor; ?>'>
                                                ...
                                                if ($organizar == 'c.data_ins DESC') {
                                                    ...
                                                    if ($organizar == 'c.last_update DESC') {
                                                        ...
                                                        <p class='op_cliente no_print'>
                                                            ...
                                                            ?>
                                                            <a href='#' onclick='javascript:abrirJanela("monitor_traffic.php?login=<?= "{$login_cliente}&router={$nas_ip[strtolower($login_cliente)]}"; ?>", 600, 650);'>
                                                                <i class="fa-solid fa-chart-line fs-5" title="Trafego Atual"></i>
                                                            </a> |
            ...
            <img src='img/icon_menu_conexoes.png' class='icon_p' title='Conexoes'>
                                                            ...
                                                            ?>
                                                                    ...
                                                                    <a href='#' onclick='javascript:abrirJanela("monitor_traffic.php?login=<?= "{$add_online}&router={$nas_ip[strtolower($add_online)]}"; ?>", 600, 650);'>
                                                                        <i class="fa-solid fa-chart-line" title="Trafego Atual"></i>
                                                                    </a> <?= $conn_add; ?>|
                                                                <?php
                                                                    } else {
                                                                ?>
...
<?php #alteracao de johny lopes ?> 
<p class='info_add'><b>CPF/CNPJ:</b> <?= $cpf_cnpj_cliente; ?></p>
<p class='info_add'><b>E-mail:</b> <?= $cli_email; ?></p>                                                    
<p class='info_add'><b>Data cadastro:</b> <?= $data_cad; ?></p>
<p class='info_add'><b>Ultima Alteracao:</b> <?= $last_update; ?></p>
...
<p></p>
                                                                        ...
                                                                        <b>Bairro: </b><?= $bairro_cliente; ?>
<p></p>
																		</b><span class='no_print'><?= $complemento_cliente; ?>
                                                                        <p></p>
...
<?php
// Localização alvo
$localizacao_alvo = '-23.29,-50.07';

// Determinar a cor com base na localização
$cor = ($loc_cliente === $localizacao_alvo) ? 'red' : 'blue';

// Gerar o link para o mapa
$link_mapa = "https://www.google.com/maps?q=" . urlencode($loc_cliente);
?>
<p class='info_add' style="color: <?= $cor; ?>;">
    <img src="img/icon_menu_mapa.png" alt="Mapa" width="20" height="20" style="vertical-align: middle; margin-right: 5px;">
    <b>
        <a href="<?= $link_mapa; ?>" style="color: <?= $cor; ?>;" target="_blank" title="Ver no Mapa">
            Localização:
        </a>
    </b> <?= $loc_cliente; ?>
</p>
...
<p></p>
<b>Vencimento da Fatura dia: </b><span class='no_print'><?= $venc_cliente; ?>
<p></p>
                                                                ...
                                                                <div class='col-8 col-sm-8 col-md-3'>
                                                                    ...
                                                                    <p class='dados_cliente <?= $color ?>'>
                                                                        ...
                                                                        <a href='https://<?= "{$ip_conn[strtolower($login_cliente)]}:{$porta_acesso3}"; ?>' target='_blank' title='Acessar porta https <?= $porta_acesso3; ?>'> <?= $porta_acesso3; ?></a>
...
<b>SINAL AT:</b> <?= $porta_olt; ?>
<p></p>

<b>OLT: </b> <?= $armario_olt; ?> <b>CARTAO/PON: </b> <?= $onu_ont; ?>
<p></p>
