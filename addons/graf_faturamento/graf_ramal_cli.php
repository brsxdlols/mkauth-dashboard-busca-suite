...
<?php include('../../topo.php'); ?>
    ...
    <table id="table_busca">
        <tr>
            <td colspan="4"><b>Gráfico de RAMAL 1 é baseado na configuração do ramal no cadastro do cliente.</b></td>
        </tr>
        <tr>
...
/*
    ...
    for($i=$per_ini; $i <= $per_meses; $i++){
        ...
        $query_mes[$i] = mysqli_query($link, "SELECT a.id, a.login, a.datapag, a.valorpag, b.ramal FROM sis_lanc a, sis_cliente b
        WHERE 
        a.login = b.login 
